 ...
 */
"use strict";var forEach=_dereq_("array-for-each-x"),defineProperty=_dereq_("object-define-property-x"),toObject=_dereq_("to-object-x"),assertIsObject=_dereq_("assert-is-object-x"),getKeys=_dereq_("get-own-enumerable-keys-x");module.exports=function defineProperties(object,properties){assertIsObject(object);var props=toObject(properties);return forEach(getKeys(props),function(property){"__proto__"!==property&&defineProperty(object,property,props[property])}),object}},{"array-for-each-x":3,"assert-is-object-x":6,"get-own-enumerable-keys-x":8,"object-define-property-x":34,"to-object-x":47}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isWorking,nativeForEach="function"==typeof Array.prototype.forEach&&Array.prototype.forEach;if(nativeForEach){var attempt=_dereq_("attempt-x"),spy=0,res=attempt.call([1,2],nativeForEach,function(item){spy+=item});if((isWorking=!1===res.threw&&"undefined"==typeof res.value&&3===spy)&&(spy="",isWorking=!1===(res=attempt.call(Object("abc"),nativeForEach,function(item){spy+=item})).threw&&"undefined"==typeof res.value&&"abc"===spy),isWorking&&(spy=0,isWorking=!1===(res=attempt.call(function(){return arguments}(1,2,3),nativeForEach,function(item){spy+=item})).threw&&"undefined"==typeof res.value&&6===spy),isWorking&&(spy=0,isWorking=!1===(res=attempt.call({0:1,1:2,3:3,4:4,length:4},nativeForEach,function(item){spy+=item})).threw&&"undefined"==typeof res.value&&6===spy),isWorking){var doc="undefined"!=typeof document&&document;if(doc){spy=null;var fragment=doc.createDocumentFragment(),div=doc.createElement("div");fragment.appendChild(div),isWorking=!1===(res=attempt.call(fragment.childNodes,nativeForEach,function(item){spy=item})).threw&&"undefined"==typeof res.value&&spy===div}}if(isWorking&&function(){return!1===Boolean(this)}()&&(spy=null,isWorking=!1===(res=attempt.call([1],nativeForEach,function(){spy="string"==typeof this},"x")).threw&&"undefined"==typeof res.value&&!0===spy),isWorking){spy={};var fn=['return nativeForEach.call("foo", function (_, __, context) {','if (Boolean(context) === false || typeof context !== "object") {',"spy.value = true;}});"].join("");isWorking=!1===(res=attempt(Function("nativeForEach","spy",fn),nativeForEach,spy)).threw&&"undefined"==typeof res.value&&!0!==spy.value}}var $forEach;if(nativeForEach)$forEach=function forEach(array,callBack){var args=[callBack];return arguments.length>2&&(args[1]=arguments[2]),nativeForEach.apply(array,args)};else{var splitIfBoxedBug=_dereq_("split-if-boxed-bug-x"),toLength=_dereq_("to-length-x"),isUndefined=_dereq_("validate.io-undefined"),toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x");$forEach=function forEach(array,callBack){var object=toObject(array);assertIsFunction(callBack);var thisArg,iterable=splitIfBoxedBug(object),length=toLength(iterable.length);arguments.length>2&&(thisArg=arguments[2]);for(var noThis=isUndefined(thisArg),i=0;i<length;i+=1)i in iterable&&(noThis?callBack(iterable[i],i,object):callBack.call(thisArg,iterable[i],i,object))}}module.exports=$forEach},{"assert-is-function-x":5,"attempt-x":7,"split-if-boxed-bug-x":43,"to-length-x":45,"to-object-x":47,"validate.io-undefined":55}],4:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":20,"is-primitive":25,"safe-to-string-x":42}],6:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsObject(value){if(isPrimitive(value))throw new TypeError(safeToString(value)+" is not an object");return value}},{"is-primitive":25,"safe-to-string-x":42}],7:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),objectKeys=_dereq_("object-keys-x"),getOEPS=_dereq_("get-own-enumerable-property-symbols-x"),concat=Array.prototype.concat;module.exports=function getOwnNonEnumerableKeys(target){var object=toObject(target);return concat.call(objectKeys(object),getOEPS(object))}},{"get-own-enumerable-property-symbols-x":9,"object-keys-x":36,"to-object-x":47}],9:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":47,"to-property-key-x":49}],13:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":29,"validate.io-undefined":55}],24:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":22,"to-number-x":46}],32:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":54,"white-space-x":56}],34:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":27}],41:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":23}],42:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":32,"to-integer-x":44}],46:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function toObject(value){return Object(requireObjectCoercible(value))}},{"require-object-coercible-x":41}],48:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":13,"to-primitive-x":48,"to-string-x":51}],50:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":29,"validate.io-undefined":55}],51:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":28}],52:[function(_dereq_,module,exports){/**
 ...
 * @module trim-left-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reLeft=new RegExp("^["+_dereq_("white-space-x").string+"]+");module.exports=function trimLeft(string){return $toString(string).replace(reLeft,"")}},{"to-string-x":51,"white-space-x":56}],53:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var $toString=_dereq_("to-string-x"),reRight=new RegExp("["+_dereq_("white-space-x").string+"]+$");module.exports=function trimRight(string){return $toString(string).replace(reRight,"")}},{"to-string-x":51,"white-space-x":56}],54:[function(_dereq_,module,exports){/**
